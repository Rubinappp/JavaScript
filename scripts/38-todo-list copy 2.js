// we are trying to use event listener here.
...
function renderTodo(){
  ...
  todolist.forEach(function(todoObject,i){
    ...
    //document.querySelector will only give first one button so use All
  ...
  // in order to put event listener for html code inside js. first it needs to be passed inside html. Then after use event listener
